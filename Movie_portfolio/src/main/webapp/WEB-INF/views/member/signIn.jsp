	...
	<section>
        ...
        <div class="container">
            <div class="user singinBx">
                ...
                <div class="formBx">
                    <form action="/member/signInPost" method="post" id="con">
                        <h2>Sign In</h2>
                        <input type="text" name="cid" id= "chkId" placeholder="UserID">
                        <input type="password" name="cpw" id="chkPw" placeholder="UserPassword">
                        <div style="color:red;font-weight:bold">${msg}</div>
                        <div><input type="submit" value="Login" onclick="return chkAccount()"><span><a href="/member/loginKAKAO"><img src="/resources/img/kakao.png"></a></span></div>
